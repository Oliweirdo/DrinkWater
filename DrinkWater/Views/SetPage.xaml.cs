...
namespace DrinkWater.Views
{
    ...
    public partial class SetPage : ContentPage
    {
        ...
        //https://stackoverflow.com/questions/39571531/c-sharp-best-way-to-schedule-recurring-task-in-an-efficient-windows-service

        private void RepeatNotification(object state)
        {
            try
            {
                OnTimerTick();
            ...
            {
                _timer?.Change(_repeatTime, Timeout.Infinite);
            }
        }
